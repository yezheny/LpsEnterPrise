package com.yxcl.lpsenterprise.utils;
...
import com.yxcl.lpsenterprise.utils.customview.recycler.SpacesItemDecoration;
...
public class Util {
    ...
    public static void RecycleCommSet(Activity activity, RecyclerView commrecycle, int HorizontalOrVertical) {
        //分割线
        int leftRight = (int) activity.getResources().getDimension(R.dimen.dp_5);
        int topBottom = (int) activity.getResources().getDimension(R.dimen.dp_05);
        int lineColor = ContextCompat.getColor(activity, R.color.gray0);
